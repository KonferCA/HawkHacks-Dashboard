...
export const applicationAccepted: AccessControlFn = () => {
	...
	return (
		mostRecentApplication?.applicationStatus === "accepted" &&
		mostRecentApplication?.accepted === true
	);
};
...
export const applicationRejected: AccessControlFn = () => {
	const { mostRecentApplication } = useApplications();
	return (
		mostRecentApplication?.applicationStatus === "rejected" &&
		mostRecentApplication?.accepted === false
	);
};
...
export const applicationPending: AccessControlFn = () => {
	const { mostRecentApplication } = useApplications();
	return (
		mostRecentApplication?.applicationStatus === "pending" &&
		mostRecentApplication?.accepted === false
	);
};
